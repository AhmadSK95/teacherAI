  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm">
        {/* Brand Header */}
        <div className="p-5 bg-gradient-to-r from-primary-700 to-primary-900">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-white tracking-tight">TeachAssist</h1>
              <p className="text-[11px] text-primary-200 font-medium">AI Teaching Assistant</p>
            </div>
          </div>
        </div>
